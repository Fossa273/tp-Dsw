...
| Req                     | Detalle                                                                                                                                                                                                                                                                                                                                                                               |
| :---------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| CRUD simple             | 1. CRUD Provincia<br>2. CRUD Vehiculo<br>3. CRUD Cliente<br>4. CRUD Localidad                                                                                                                                                                                                                                                                                                         |
| CRUD dependiente        | 1. CRUD Viaje {depende de} CRUD Reserva y CRUD Vehiculo<br>2. CRUD Trayecto {depende de} CRUD Localidad                                                                                                                                                                                                                                                                               |
...
| Req      | Detalle                                                                                                                                                                             |
| :------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CRUD     | 1. CRUD Reserva<br>2. CRUD Viaje<br>3. CRUD Trayecto<br>4. CRUD Localidad<br>5. CRUD Conductor<br>6. CRUD Vehiculo<br>7. CRUD Cliente <br>8. CRUD Provincia                         |
...
| CUU/Epic | 1. Reprogramar una reserva                          |
